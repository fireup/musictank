...
//    arrOfImages = [arr retain];
    arrOfImages = [NSMutableArray arrayWithArray:arr];
    pageControl = [[UIPageControl alloc] init];
    pageControl.frame = CGRectMake((98/[[UIScreen mainScreen] bounds].size.width)*self.frame.size.width,(20/[[UIScreen mainScreen] bounds].size.height)*self.frame.size.height, 122, 36);
